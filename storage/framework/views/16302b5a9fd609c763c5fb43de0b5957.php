      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <select name="uom_type" id="uom_type" class="w-full border rounded px-3 py-2">
            <option value="volume" <?php if(old('uom_type','volume')==='volume'): echo 'selected'; endif; ?>>Volume (L/ml)</option>
          </select>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div>
          ...
          <input name="category" value="<?php echo e(old('category')); ?>" class="w-full border rounded px-3 py-2" placeholder="e.g., beverage, meat" />
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div id="volume_fields">
          ...
          <div class="flex gap-2">
            <input type="number" step="0.001" min="0.001" name="volume_value" value="<?php echo e(old('volume_value')); ?>" class="w-full border rounded px-3 py-2" placeholder="mfano, 500" />
...
unset($__errorArgs, $__bag); ?>
        ...
        <div id="carton_field">
          ...
          <input type="number" min="1" name="carton_size" id="carton_size" value="<?php echo e(old('carton_size')); ?>" class="w-full border rounded px-3 py-2" placeholder="Units per carton" />
