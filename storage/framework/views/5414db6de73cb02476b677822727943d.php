  ...
  <div class="bg-white rounded border p-4 grid grid-cols-1 md:grid-cols-3 gap-4">
    ...
    <div class="md:col-span-2 space-y-2">
      <div class="flex items-center gap-2">
        ...
        <span class="text-xs px-1.5 py-0.5 rounded bg-gray-100 text-gray-700"><?php echo e(ucfirst($item->uom_type ?? 'unit')); ?></span>
      </div>
      ...
      <?php if(($item->uom_type ?? 'unit') !== 'weight'): ?>
      ...
      <div class="pt-2 flex flex-wrap gap-2">
        ...
        <a href="<?php echo e(route('losses.create', ['item_id' => $item->id])); ?>" class="px-3 py-2 bg-red-600 text-white rounded">Record Loss</a>
