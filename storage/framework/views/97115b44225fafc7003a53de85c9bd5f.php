...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  ...
  <div class="mb-4 flex items-center gap-2">
    <a href="<?php echo e(route('items.create')); ?>" class="px-3 py-2 text-sm rounded border bg-white hover:bg-gray-50">+ Add kinywaji</a>
    <a href="<?php echo e(route('meat.create')); ?>" class="px-3 py-2 text-sm rounded border bg-red-50 text-red-700 hover:bg-red-100">+ Add meat</a>
  ...
  <div class="grid grid-cols-1 <?php echo e(auth()->user()->isAdmin() ? 'sm:grid-cols-3' : 'sm:grid-cols-2'); ?> gap-4 sm:gap-6">
    ...
    <?php else: ?>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <a href="<?php echo e(route('items.show.single', ['id' => $item->id])); ?>" class="block border rounded overflow-hidden bg-white hover:shadow <?php echo e($item->is_active ? '' : 'opacity-50'); ?>">
            ...
            <div class="p-2">
              ...
              <div class="text-xs text-gray-600">
                <?php if($item->uom_type === 'weight'): ?>
                  Stock: <?php echo e($item->formatBaseQuantity($item->stock_remaining)); ?>
