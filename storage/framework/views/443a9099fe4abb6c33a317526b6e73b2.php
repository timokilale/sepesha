  ...
  <div class="bg-white rounded border p-4" x-data="{ show: false }">
    <form method="POST" action="<?php echo e(route('profile.update')); ?>" class="space-y-4">
      ...
      <div>
        ...
        <input name="name" value="<?php echo e(old('name', auth()->user()->name)); ?>" class="w-full border rounded px-3 py-2" required />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div>
        ...
        <input type="tel" name="phone" value="<?php echo e(old('phone', auth()->user()->phone)); ?>" pattern="^(?:255\d{9}|0\d{8})$" placeholder="e.g. 255714609135" class="w-full border rounded px-3 py-2" required />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div>
        ...
        <input type="email" name="email" value="<?php echo e(old('email', auth()->user()->email)); ?>" class="w-full border rounded px-3 py-2" required />
...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
        ...
        <a href="<?php echo e(route('home')); ?>" class="px-3 py-2 bg-gray-100 rounded text-center">Cancel</a>
      </div>
    </form>
  </div>
</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MSA WIN10 G\Desktop\CascadeProjects\windsurf-project\resources\views/auth/profile.blade.php ENDPATH**/ ?>