...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
  <div class="flex flex-col sm:flex-row sm:items-center justify-between mb-4 gap-3">
    ...
    <a href="<?php echo e(route('sales.create')); ?>" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 text-center">Add Sale</a>
  </div>
  ...
  <div class="bg-white rounded shadow overflow-hidden">
          ...
          <tr>
            ...
            <td class="px-2 sm:px-4 py-2 text-right">
              <div class="flex flex-col sm:flex-row gap-1 sm:gap-2 justify-end">
                <a href="<?php echo e(route('sales.edit', $s)); ?>" class="text-indigo-600 text-sm hover:text-indigo-800">Edit</a>
                <form action="<?php echo e(route('sales.destroy', $s)); ?>" method="POST" class="inline">
                  <?php echo csrf_field(); ?>
    ...
    <div class="p-4"><?php echo e($sales->links()); ?></div>
  </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MSA WIN10 G\Desktop\CascadeProjects\windsurf-project\resources\views/sales/index.blade.php ENDPATH**/ ?>